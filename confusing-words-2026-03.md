...
| **175** | **scope** (n. 范围 / 视野)<br>**slope** (n. 斜坡 / 斜率) | The new **scope** of the environmental project includes planting trees on the steep **slope** to prevent soil erosion. |
| **176** | **rally** (v./n. 集合 / 集会)<br>**array** (n. 一大批 / 阵列) | The political leader managed to **rally** an impressive **array** of supporters for the upcoming election campaign. |
| **177** | **scorn** (v./n. 轻蔑 / 鄙视)<br>**scold** (v. 训斥 / 责骂) | Instead of expressing **scorn** for the employee's mistake, the manager decided to gently **scold** him and provide further training. |
| **178** | **peer** (n. 同龄人 / 同辈)<br>**per** (prep. 每一) | The study revealed that pressure from a **peer** can significantly affect a student's reading hours **per** week. |
| **179** | **utter** (v. 说出; adj. 完全的)<br>**alter** (v. 改变 / 更改) | The politician did not **utter** a single word about his controversial plan to radically **alter** the current tax policies. |
| **180** | **thrift** (n. 节俭 / 节约)<br>**trim** (v. 修剪 / 削减) | In the spirit of financial **thrift**, the struggling company decided to **trim** its unnecessary administrative expenses. |
| **181** | **thrive** (v. 兴旺 / 繁荣)<br>**strive** (v. 努力 / 奋斗) | For a business to truly **thrive** in a highly competitive market, its employees must continuously **strive** for technical innovation. |
| **182** | **pensive** (adj. 沉思的 / 忧伤的)<br>**deceive** (v. 欺骗)<br>**conceive** (v. 构想 / 设想) | The **pensive** detective tried to **conceive** of a clever scenario where the suspect could successfully **deceive** the advanced security system. |
| **183** | **patch** (n. 小块 / 补丁)<br>**pitch** (n. 场地 / 投掷) | The local community volunteers spent the whole morning fixing a rough **patch** of grass on the neighborhood football **pitch**. |
| **184** | **raise** (v. 举起 / 提高)<br>**arouse** (v. 引起 / 激发)<br>**arise** (v. 发生 / 出现)<br>**rise** (v. 上升) | The government's decision to **raise** taxes is likely to **arouse** public anger, causing new social conflicts to **arise** even as employment rates **rise**. |
| **185** | **urgent** (adj. 紧急的 / 急迫的)<br>**surge** (n./v. 涌动 / 激增) | There is an **urgent** need for medical supplies following the unexpected **surge** in severe flu cases this winter. |
| **186** | **pattern** (n. 模式 / 图案)<br>**patent** (n. 专利; adj. 显然的) | The tech company noticed a clear **pattern** of intellectual property theft before urgently applying for a new software **patent**. |
| **187** | **means** (n. 方式 / 手段)<br>**mean** (v. 意味着; adj. 吝啬的) | While public transport is an eco-friendly **means** of travel, it does not **mean** that all modern cities have the infrastructure to support it. |
| **188** | **imitation** (n. 模仿 / 仿制品)<br>**intimate** (adj. 亲密的 / 私人的) | The painting was merely a cheap **imitation**, completely lacking the **intimate** emotional details found in the original masterpiece. |
| **189** | **occur** (v. 发生 / 存在)<br>**incur** (v. 招致 / 引发) | If further unexpected delays **occur** during the construction process, the contractor will inevitably **incur** massive financial penalties. |
| **190** | **span** (n. 跨度 / 一段时间)<br>**spin** (v. 旋转 / 纺纱) | Over a short **span** of ten years, the brilliant media company managed to **spin** the controversial story completely to their advantage. |
| **191** | **image** (n. 图像 / 形象)<br>**imagine** (v. 想象) | It is difficult to **imagine** how the severe environmental pollution scandal will permanently damage the corporation's public **image**. |
| **192** | **quit** (v. 停止 / 辞职)<br>**quiet** (adj. 安静的)<br>**quite** (adv. 相当) | It is **quite** understandable why she decided to **quit** her stressful corporate job and move to a incredibly **quiet** countryside town. |
| **193** | **loading** (n. 装载 / 载荷)<br>**landing** (n. 降落 / 着陆) | The excessively heavy **loading** of the commercial cargo plane significantly complicated its emergency **landing** procedure. |
| **194** | **generator** (n. 发电机)<br>**elevator** (n. 电梯) | When the city's power grid failed, the hospital's backup **generator** immediately kicked in to keep the main **elevator** running securely. |
| **195** | **levy** (n./v. 征税 / 征收)<br>**envy** (n./v. 羡慕 / 嫉妒) | The government decided to **levy** a heavy tax on luxury cars, a controversial move aimed at reducing the social **envy** between different income classes. |
| **196** | **ignore** (v. 忽视 / 不理睬)<br>**ignorant** (adj. 无知的 / 愚昧的) | We simply cannot afford to **ignore** the severe consequences of global climate change, nor should we remain **ignorant** of sustainable agricultural practices. |
| **197** | **scheme** (n. 计划 / 方案)<br>**schedule** (n. 日程表 / 计划表) | The ambitious urban development **scheme** fell completely behind its original construction **schedule** due to a severe lack of funding. |
| **198** | **imaginary** (adj. 想象中的 / 虚构的)<br>**imagery** (n. 意象 / 比喻) | The talented author used vivid natural **imagery** to precisely describe the highly detailed, **imaginary** world in his latest science fiction novel. |
| **199** | **opposite** (adj. 对面的 / 相反的)<br>**oppose** (v. 反对 / 阻挠) | Many local residents strongly **oppose** the new urban development plan, arguing that it will negatively impact the community located on the **opposite** side of the river. |
| **200** | **wonder** (v. 想知道 / 感到诧异)<br>**render** (v. 使变得 / 给予 / 翻译)<br>**wander** (v. 闲逛) | As tourists **wander** through the ancient ruins, they often **wonder** about the catastrophic historical events that could **render** such a magnificent empire entirely powerless. |
